 ...
 * to validate and authenticate JWT tokens. It ensures that requests with valid tokens
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Filters incoming HTTP requests to validate JWT tokens and set the authentication
